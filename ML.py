...
mae_train_score_LR=mean_absolute_error(y_train_actual_LR,y_train_prediction_LR)
rmse_train_LR=root_mean_squared_error(y_train_actual_LR,y_train_prediction_LR)
print("MSE_train_LR:",mse_train_score_LR)
print("R2_train_LR:",r2_train_LR) 
print("mae_train_score_LR:",mae_train_score_LR)
print("rmse_train_LR:",rmse_train_LR) 
print()
...
mae_test_score_LR=mean_absolute_error(y_test_actual_LR,y_test_prediction_LR)
rmse_test_LR=root_mean_squared_error(y_test_actual_LR,y_test_prediction_LR)
print("MSE_test_LR:",mse_test_score_LR)
print("R2_test_LR:",r2_test_LR) 
print("mae_test_score_LR:",mae_test_score_LR)
print("rmse_test_LR:",rmse_test_LR) 
# test:0.2
...
#predict
y_prediction_SVR=model_svr.predict(x_test)
y_actual_SVR=y_test

# ------------------------------------------------------------------------------

# SVR - Evaluation
mse_score_svr=mean_squared_error(y_actual_SVR,y_prediction_SVR)
r2_svr=r2_score(y_actual_SVR,y_prediction_SVR)
print("mse_score_SVR",mse_score_svr)
print("r2_SVR",r2_svr)
# '''
# ------------------------------------------------------------------------------
